...
"""
Video tools router - lightweight video processing endpoints.
Handles: upload-video, slowmo, fastmo, convert, compress, remove-watermark-video
"""
...
from config import UPLOAD_DIR, OUTPUT_DIR, FRAMES_DIR
